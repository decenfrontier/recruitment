# Generated by Django 3.2.5 on 2021-07-08 08:47
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.SmallIntegerField(choices=[(0, '技术类'), (1, '产品类'), (2, '运营类'), (3, '设计类')], verbose_name='职位类别')),
                ('name', models.CharField(max_length=100, verbose_name='职位名称')),
                ('city', models.SmallIntegerField(choices=[(0, '北京'), (1, '上海'), (2, '深圳')], verbose_name='工作地点')),
                ('responsibility', models.TextField(max_length=1024, verbose_name='职位职责')),
                ('requirement', models.TextField(max_length=1024, verbose_name='职位要求')),
